...
def syncListeners(conn, task_cursor, source_cursor, deviant_secret, deviant_id, shard_id, givenPool: Pool):
                            ...
                            if inverse:
                                ...
                                while not passes == new_deviation_count:
                                    ...
                                    entry:DeviationNotification = DeviationNotification(
                                        "normal", channel_id, artist, foldername, obt_last_urls[temp_index],
